  ...
  try {
    ...
    if (category === "portal") {
      const keysToEnsure = [
        ...
        { key: "landing_stat1_number", value: "Dezenas de", desc: "Landing Estatística 1: Número (ex: Dezenas de, +50)" },
        { key: "landing_stat1_label", value: "Artistas Cadastrados", desc: "Landing Estatística 1: Rótulo (ex: Artistas Cadastrados)" },
        { key: "landing_stat2_number", value: "Centenas de", desc: "Landing Estatística 2: Número (ex: Centenas de, +500)" },
        { key: "landing_stat2_label", value: "Músicas Organizadas", desc: "Landing Estatística 2: Rótulo (ex: Músicas Organizadas)" },
        { key: "landing_stat3_number", value: "Milhares de", desc: "Landing Estatística 3: Número (ex: Milhares de, +10 Mil)" },
        { key: "landing_stat3_label", value: "Visualizações nos Perfis", desc: "Landing Estatística 3: Rótulo (ex: Visualizações nos Perfis)" },
        { key: "landing_stat4_number", value: "Em Todo", desc: "Landing Estatística 4: Número (ex: Em Todo)" },
        { key: "landing_stat4_label", value: "o Brasil", desc: "Landing Estatística 4: Rótulo (ex: o Brasil)" },
        { key: "landing_social_proof_text", value: "Dezenas de artistas no Portal do Artista", desc: "Landing: Texto de Prova Social (Abaixo do Hero)" },
