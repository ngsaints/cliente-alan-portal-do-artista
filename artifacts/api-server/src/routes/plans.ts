  ...
  try {
    ...
    const [updatedArtist] = await db
      ...
      .set({
        ...
        personalizacaoPercent: plan.personalizacaoPercent,
        planoAtivo: true,
      })
  ...
  try {
    const defaultPlans = [
      ...
      },
      {
        ...
        descricao: "60 músicas, 50% de personalização",
      ...
      },
      {
        ...
        descricao: "150 músicas, 100% de personalização",
