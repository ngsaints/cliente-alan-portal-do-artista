  ...
  try {
    ...
    const [updatedArtist] = await db
      ...
      .set({
        ...
        documento: documento !== undefined ? documento : currentArtist.documento,
        ...
        cardStyle: cardStyle !== undefined ? cardStyle : (currentArtist as any).cardStyle,
      })
    ...
    res.json({
      ...
      documento: updatedArtist.documento,
      ...
      cardStyle: (updatedArtist as any).cardStyle,
    });
  } catch (error) {
